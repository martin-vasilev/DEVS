...
######################################################################################
# Note: the code below contains post-hoc analyses requested by some of the Reviewers:

#######
# investigate if deviance distraction differs between fast and slow readers:
...
############################
## Add target word position (2-5) in the models:
